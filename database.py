...
class Movie:
    def __init__(self, title, year, genre, watched=False):
        """
    ...
    def __repr__(self):
        return f"Movie(title={self.title}, year={self.year}, genre={self.genre}, watched={self.watched})"
...
class MovieManager:
    ...
    def get_all_movies(self):
        ...
        conn.close()
        return [Movie(title=movie[1], year=movie[2], genre=movie[3], watched=bool(movie[4])) for movie in movies]
